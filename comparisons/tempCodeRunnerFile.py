...
# Initialize and fit your LinearRegression model
my_model = LinearRegression(
    lr=0.01, n_epochs=1000, method="batch", verbose=True, batch_size=64
)
...
# Calculate the Mean Squared Error on the test set using your model
